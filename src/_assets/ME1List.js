export default {
  ...
  6: {
    title: `HINT: Credits`,
    desc: `You can amass a large amount of wealth by collecting everything you find in lockers and crates, and selling them. If you have one million credits by the end of the game, you get a head-start in the second game.`,
    timeline: {
  ...
  63: {
    title: `HINT: Let Wrex Live`,
    desc: `Even if you don't like him, do your best to let him live during the stand-off.<br /><br />
      You can avoid having to kill him by either having a high charm/intimidate skill, or by doing his assignment (Wrex: Family Armor).`,
    timeline: {
      before: `Virmire: Wrex and the Genophage`,
      after: `Chapter 5: Virmire - Saren's Plan`
    },
  ...
  67: {
    title: `HINT: Kill Rana Thanoptis`,
    desc: `Don't let Rana Thanoptis leave the facility alive, she betrays you more than once in future games, and this is the only chance you have to stop her parmanently.`,
    timeline: {
      before: `Virmire: Assault (Planting the bomb)`,
      after: `Virmire: Assault (Saren's base interior)`
    },
    completion: {
      done: false,
      datetime: null
  ...
  68: {
    title: `HINT: Charm/Intimidate Saren`,
    desc: `During your confrontation with Saren at the end of Virmire: Assault, if you dig deeper into the chat (using informational dialogue options on the left side of the wheel), you will get the option to charm or intimidate him.<br /><br />
      Using them will not change anything immediately, but it will near the end of the game.`,
    timeline: {
  ...
  72: {
    title: `HINT: No more important Citadel missions`,
    desc: `At this point, you shouldn't be left with any major Citadel missions, as the important ones would have been completed earlier. The two missions available here don't really have far-reaching consequences, save for a few messages in the nexty game. Complete them at your leisure before continuing.`,
    timeline: {
      before: `Chapter 7: Ilos - Find the Conduit`,
      after: `Virmire: Assisting Kirrahe's Team`
    },
    completion: {
      done: false,
      datetime: null
  ...
  79: {
    title: `HINT: Use the Trinket on Eletania`,
    desc: `After acquiring the trinket from Sha'ira during Citadel: Asari Consort, go to Eletania and use the trinket on the Prothean ruins.<br /><br />
      Eletania can be found in the Hercules System in Attican Beta.`,
    timeline: {
      before: `Chapter 7: Ilos - Find the Conduit`,
      after: `Citadel: Xeltan's Complaint`
    },
    completion: {
      done: false,
      datetime: null
  ...
  92: {
    title: `HINT: Drive-by the Colossi`,
    desc: `There's very little time to deal with all of the Colossi on the run-up to the Conduit, you should be able to just drive right by them in the Mako without any issues.`,
    timeline: {
      before: `Race Against Time: Final Battle`,
      after: `Chapter 8: Race Against Time - Conduit (Start)`
    },
    completion: {
      done: false,
      datetime: null
  ...
  96: {
    ...
    timeline: {
      before: `Epilogue`,
      after: `Race Against Time: Final Battle (Start)`
    },
    completion: {
      done: false,
      datetime: null
  ...
  102: {
    title: `HINT: It doesn't matter what you choose`,
    desc: `Your choice of leader in this scene doesn't matter, as for whatever reason it isn't saved. In the second game, you make this decision again at the beginning.`,
    timeline: {
      before: `Epilogue (End)`,
      after: `Epilogue (Start)`
    },
    completion: {
      done: false,
      datetime: null
